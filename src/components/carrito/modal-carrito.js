                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                              ...
                              <div className="flex flex-1 items-end justify-between text-sm mt-4">
                                <form action={restarAlCarrito}>
                                  ...
                                  <button type="submit" className="font-medium text-indigo-600 hover:text-indigo-500">Restar</button>
                                </form>
                                <p className="text-gray-500">{item.cantidad}</p>
                                <form action={sumarAlCarrito}>
                                  <input type="hidden" name="orderItemId" value={item.id} />
                                  <button type="submit" className="font-medium text-indigo-600 hover:text-indigo-500">Sumar</button>
                                </form>
                                <form action={eliminarDelCarrito}>
                                  <input type="hidden" name="orderItemId" value={item.id} />
                                  <button type="submit" className="font-medium text-red-600 hover:text-red-500">Eliminar</button>
                                </form>
                              </div>
                            </div>
                          </li>
